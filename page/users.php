        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    if (isset($_POST['edit'])) {
                        $hashed_password = password_hash($password, PASSWORD_DEFAULT); // Hash the password for security
                        $sql = "UPDATE users SET name = ?, usertype = ?, password = ?, lastUpdatedAt = CURRENT_TIMESTAMP WHERE username = ?";
                        $stmt = mysqli_prepare($conn, $sql);
                        if ($stmt) {
                            mysqli_stmt_bind_param($stmt, "ssss", $name, $usertype, $hashed_password, $username);
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td>
                                                        <span class="custom-checkbox">
                                                            <input type="checkbox" id="checkbox<?php echo $i; ?>" name="pilih[]" value="<?php echo $row['username']; ?>">
                                                            <label for="checkbox<?php echo $i; ?>"></label>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <a href="#viewUserModal<?php echo $row['username']; ?>" class="view" data-toggle="modal"><i class="fas fa-search" data-toggle="tooltip" title="View">&#xE254;</i></a>
                                                        <a href="#editUserModal<?php echo $row['username']; ?>" class="edit" data-toggle="modal"><i class="fas fa-edit" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                        <a href="#deleteUserModal<?php echo $row['username']; ?>" class="delete" data-toggle="modal"><i class="fas fa-trash-alt" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                                    </td>
                                                ...
                                                <!-- View Modal HTML -->
                                                <div id="viewUserModal<?php echo $row['username']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form method="post" action="">
                                                                <input type="hidden" class="form-control" value="<?php echo $row['username']; ?>" name="username" required>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" value="<?php echo $row['usertype']; ?>" name="usertype" disabled>
                                                                    </div>
                                                                </div>
                                                ...
                                                <!-- Edit Modal HTML -->
                                                <div id="editUserModal<?php echo $row['username']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form method="post" action="">
                                                                <input type="hidden" class="form-control" value="<?php echo $row['username']; ?>" name="username" required>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>User Type</label>
                                                                        <input type="text" class="form-control" value="<?php echo $row['usertype']; ?>" name="usertype" required>
                                                                    </div>
                                                                    <div class="form-group">
